    ...
    public function InsertEvaluation()
    {
		...
		if(isset($_POST['submit']))
		{
			...
			/**Validating data fields*/
                ...
                $mail->Body    = 'This is the final evaluation of the student '.$sid.',<br><br>Feedback for the initial contract and actual assignment  -  <b>'.$area1.'</b><br>Feedback for the personal charactor- <b>'.$area2.'</b> <br><br>Feedback for the professional development  -  <b>'.$area3.'</b> <br><br>Feedback for the needs of organization  -  <b>'.$area4.'</b> <br><br><br> The supervisor name is '.$exsup.' <br><br> Date -'.$date.' <br><br>Thank you';
